...
/**
 * DatosAcademicosController
 */
@RestController
@RequestMapping(DatosAcademicosController.REQUEST_MAPPING)
@RequiredArgsConstructor
@Slf4j
public class DatosAcademicosController {

  public static final String PATH_DELIMITER = "/";
  public static final String REQUEST_MAPPING = PATH_DELIMITER + "datos-academicos";
