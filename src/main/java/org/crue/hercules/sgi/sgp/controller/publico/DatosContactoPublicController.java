...
/**
 * DatosContactoPublicController
 */
@RestController
@RequestMapping(DatosContactoPublicController.REQUEST_MAPPING)
@RequiredArgsConstructor
@Slf4j
public class DatosContactoPublicController {

  public static final String PATH_DELIMITER = "/";
  public static final String PATH_PUBLIC = PATH_DELIMITER + "public";
  public static final String REQUEST_MAPPING = PATH_PUBLIC + PATH_DELIMITER + "datos-contacto";
